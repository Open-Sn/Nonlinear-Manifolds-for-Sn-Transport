...
CENTER_OUTPUT_PATH = "../run/preparation/snapshots/center_col.npy"
...
def main():
    ...
    if CENTER_FILE is not None:
        ...
        np.save(CENTER_OUTPUT_PATH, center_col)
        print("Saved centering vector to: {}".format(CENTER_OUTPUT_PATH))
